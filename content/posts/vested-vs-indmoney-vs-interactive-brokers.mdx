...
Rovia follows the same architectural pattern as Vested and INDmoney, but partners with **Alpaca Securities** instead of DriveWealth or Stockal.
...
| Rovia | 0 paise platform-side (you negotiate the bank rate, or pay the wire-provider's charges) |
...
| Rovia (0 platform; bank rate applies) | Rs 0 - 7,186 (depends on your bank) |
| IBKR (3p) | Rs 359 |

Rovia is unusual on this dimension: the platform itself doesn't take a cut on the USD-to-INR conversion at repatriation. Your wire arrives in your Indian bank as USD and your bank's FX rate determines the cost. If you can negotiate a tight rate with your relationship banker (HNI customers at most major Indian banks can get within 30 to 50 paise of interbank), that's what you pay. If you accept the standard published wire rate, you pay whatever that is. Rovia doesn't add anything on top.
...
| INDmoney | Same &mdash; full Indian tax-friendly outputs |
...
What about the Indian platform itself failing? Vested, INDmoney, and Rovia are all private companies. If any of them go bankrupt, your shares remain at the US broker (DriveWealth, Stockal, or Alpaca respectively) in your name. You'd contact the US broker directly to claim them. Not zero-friction, but not catastrophic.
...
| INDmoney | Similar |
| Rovia | 3 - 5 business days; 0 platform fee on FX (bank or wire-provider charges only) |
| IBKR | 2 - 5 business days, best FX |

All four are workable. The Rovia model is structurally different from Vested and INDmoney here: rather than bundling FX markup into the platform's economics, the conversion happens at your Indian bank under whatever rate you've negotiated. For HNI banking customers this can be the cheapest path of the four; for a standard retail bank account it's roughly comparable to INDmoney. IBKR remains the cheapest in absolute terms because the conversion happens internally at near-interbank rates.
...
| INDmoney | Not supported. New deployments only. |
...
If you have meaningful vested RSUs at an employer broker today and you want to move them rather than sell first, the only currently-realistic path among the four platforms is Rovia. We covered the mechanics in [the share-transfer post](/posts/share-transfer-between-brokers-india).
...
| INDmoney | Yes | Limited; FIFO default | Basic capital gains report |
...
|---|---|---|---|---|
| FX markup on inbound LRS (Rs 10L x 5 yrs x 75p / 60p / bank-rate / 3p per $) | Rs 44,910 | Rs 35,928 | Bank-rate dependent | Rs 1,796 |
...
| **Total 5-year cost (excl. Rovia FX)** | **Rs 59,910** | **Rs 50,928** | **Rs 10,000 + your bank's FX** | **Rs 4,446** |

A note on the Rovia row: the platform doesn't take a cut on FX, so the inbound conversion cost depends entirely on what rate your bank gives you when sending USD to your Rovia account. Indian bank wholesale rates for outbound USD wires typically run 50 to 100 paise wider than interbank for retail customers, and 20 to 50 paise wider for HNI / priority-banking customers. For someone who can negotiate a tight rate, the total 5-year cost can be lower than INDmoney; for someone on the standard retail banking rate, it can be similar.

IBKR remains the cheapest in absolute terms if you're willing to handle US-format tax docs yourself. Among the Indian-aware platforms, the right comparison depends on your banking relationship. Across all four platforms, the bigger savings often come from disciplined lot selection and loss harvesting &mdash; which we'd estimate is worth multiples of any platform-fee difference for a typical RSU holder with meaningful realized gains.
...
The trade-off is breadth. If you want every NYSE small-cap and access to UCITS funds today, Vested or INDmoney has a wider catalog at launch. Rovia's roadmap (Q2/Q3 2026 for UCITS and global stocks) is real but unshipped at the time of writing.
...
| Rs 5 - 25 lakh/year, no RSUs | INDmoney leans cheaper; Vested leans more polished. Pick based on UX preference. |
