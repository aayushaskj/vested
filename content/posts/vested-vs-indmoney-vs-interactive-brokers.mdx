...
| INDmoney | Similar |
| Rovia | 3 - 5 business days, similar FX to INDmoney |
| IBKR | 2 - 5 business days, best FX |

All four are fine. IBKR is marginally faster and cheaper.
...
|---|---|---|---|---|
| FX markup (Rs 10L x 5 yrs x 75p / 60p / 60p / 3p per $) | Rs 44,910 | Rs 35,928 | Rs 35,928 | Rs 1,796 |
...
| **Total 5-year cost** | **Rs 59,910** | **Rs 50,928** | **Rs 45,928** | **Rs 4,446** |

IBKR remains by far the cheapest if you're willing to handle US-format tax docs yourself. Among the Indian-aware platforms, Rovia is the cheapest by a margin of roughly Rs 5,000 over a 5-year cycle for this scenario, mostly from the lower brokerage commission. The bigger savings, when they apply, come from disciplined lot selection and loss harvesting &mdash; which we'd estimate is worth multiples of the cost difference for a typical RSU holder with meaningful realized gains.
