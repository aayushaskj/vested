...
This is one of the reasons we built [Rovia](https://rovia.one). The lot-level INR cost basis, the LT/ST timer, the "harvest this lot" suggestions when realized gains appear elsewhere in your portfolio, and the ITR-ready schedule are the features that turn this from a hours-of-spreadsheet exercise into a couple of clicks. Other platforms do parts of this — INDmoney shows you holdings in INR; the original Vested platform does some basic lot reporting. None of them, that we've seen, fully automate the harvest-suggestion-and-execute flow specifically for RSU holders.
