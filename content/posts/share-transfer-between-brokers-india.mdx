...
The "Indian-friendly" platforms that exist (INDmoney, the original Vested platform, Stockal-now-Borderless) all work by opening you an account with a US partner broker — DriveWealth and Alpaca being the two most common. But until very recently, none of them supported inbound ACATS for an existing RSU position. You could open a fresh account and buy new shares, but you couldn't bring your existing vested RSUs home.
...
We're not the only ones doing this. INDmoney and the original Vested platform have been around longer and serve a broader retail US-investing audience. The differences are in focus and pricing — Rovia is built specifically for RSU and equity-comp holders rather than general retail; brokerage is 0.15% versus the 0.25% standard at INDmoney and the original Vested; and the reporting and lot-selection automation is geared at the kind of cross-border tax optimization that matters when you're holding meaningful US equity through your employer.
