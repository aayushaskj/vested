...
The currently-available receiving options for Indian residents narrow to platforms partnered with Alpaca Securities. INDmoney supports inbound ACATS through its Alpaca partnership; Rovia does too via the same partner. The original Vested platform (DriveWealth-only) currently doesn't support inbound ACATS.
