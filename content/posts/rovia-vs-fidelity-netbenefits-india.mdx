...
PAN, Aadhaar, bank account, video KYC, W-8BEN. Onboarding takes 1 to 3 days for KYC + Alpaca account opening. You don't need to fund the account with INR via LRS for the share-transfer flow. [Open a Rovia account](https://rovia.onelink.me/xOtI/c29h3ped).
