...
If your shares were at a platform that lets you hold USD and deploy into other US ETFs without round-tripping through INR, you'd save the FX both ways. Worth noting that Rovia takes 0 platform fee on the eventual USD-to-INR conversion when you do choose to repatriate &mdash; you pay only your Indian bank's rate or whatever the wire-provider charges. You can negotiate that rate with your bank directly. The conversion economics aren't a Rovia revenue line.
...
Standard onboarding: PAN, Aadhaar, bank account, video KYC. Takes 1 to 3 days for KYC + Alpaca account opening. You'll sign a W-8BEN treaty form during onboarding, which sets you up for the 25% reduced US dividend withholding (instead of 30%). [Open a Rovia account](https://rovia.onelink.me/xOtI/c29h3ped).
